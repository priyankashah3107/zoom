      ...
      <div className="flex-grow flex items-center justify-center">
        <div className="flex flex-col items-center gap-6 text-white text-center">
          <div className="flex flex-col gap-[24px]">
            <h2 className="text-center text-white text-xl lg:text-2xl font-semibold font-['General Sans']">
              Left webinar “My Webinar”.
            </h2>
            <div className="flex flex-row gap-1 items-center text-white/60 text-base lg:text-xl font-medium font-['General Sans'] text-center justify-center">
