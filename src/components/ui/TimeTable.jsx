...
export const TimeTable = () => {
  return (
    <div className="w-full bg-white rounded-xl shadow border border-black/10 p-4 md:p-6">
      <div className="flex flex-col md:flex-row justify-between items-center bg-[#002b5b]/5 rounded-md p-2.5">
        <div className="flex items-center gap-2.5 mb-2 md:mb-0">
          ...
          <H3>{date}</H3>
          <button>
            <img src={DropDown} alt="Dropdown" className="size-4" />
          </button>
        </div>
